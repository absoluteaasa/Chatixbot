...
INSTALL_TEXT = """
📦 <b>Инструкция по установке Chatix b1.6</b>

<b>Шаг 1 — Создай бота</b>
Перейди к @BotFather → /newbot → придумай имя и юзернейм → скопируй токен

<b>Шаг 2 — Установка (Termux / Android)</b>
<code>pkg update && pkg upgrade -y
pkg install python git -y
pip install aiogram sqlalchemy aiosqlite python-dotenv</code>

<b>Шаг 3 — Скачай бота</b>
<code>git clone https://github.com/ВАШ_РЕП/chatixb1.6
cd chatixb1.6</code>

<b>Шаг 4 — Настройка</b>
<code>cp .env.example .env
nano .env</code>
Впиши токен: <code>BOT_TOKEN=твой_токен</code>

<b>Шаг 5 — Запуск</b>
<code>python bot.py</code>

<b>Шаг 6 — Добавь бота в чат</b>
Добавь бота в группу → дай права администратора → напиши <b>старт</b>
...
async def cmd_start(message: Message) -> None:
    ...
    if message.chat.type == "private":
        ...
        await message.answer(
            ...
            f"Я <b>Chatix b1.6</b> — менеджер чатов с экономикой, играми и модерацией.\n\n"
...
async def on_new_member(event: ChatMemberUpdated) -> None:
    ...
    if cs and cs.welcome_message:
        ...
        text = (
            ...
            f"Я <b>Chatix b1.6</b> — менеджер этого чата.\n"
