"""
Chatix | Чат-менеджер — точка входа
"""
import asyncio
import logging
...
from handlers import moderation, economy, reputation, marriage, misc, profile, roles, shop, spam, top
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("chatix.log", encoding="utf-8"),
